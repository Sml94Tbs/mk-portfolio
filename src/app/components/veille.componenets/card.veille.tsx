...
const CardVeille = ({key, title, date, desc, link}:{key: number, title : string, date:string, desc: string, link:string}) => {
    return (
        <Link href={link} target="_blank">
            <div className=" bg-[#8a4848] flex justify-center text-white border-2 border-solid rounded-[1rem]  transition-[cubic-bezier(0.25_0.1_0.25_1.0)] duration-[.5s] hover:scale-[1.02]">
